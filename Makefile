...
ifdef JAVASCRIPT
CXX			 := em++
CXXFLAGS += -D_JAVASCRIPT -s ALLOW_MEMORY_GROWTH=1 -s DEMANGLE_SUPPORT=1 -s ASYNCIFY  -s USE_PTHREADS=1 -s PROXY_TO_PTHREAD
LDFLAGS +=  -O3 -s ASYNCIFY -s ALLOW_MEMORY_GROWTH=1 -s USE_PTHREADS=1 -s PROXY_TO_PTHREAD
else
CXXFLAGS += -fopenmp
LDFLAGS += -fopenmp
endif
